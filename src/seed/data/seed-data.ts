...
export const initialData: SeedData = {
    ...
    users: [
        {
            email: "cdales0@wunderground.com",
            fullName: "Constantine Dales",
            roles: ['super-user','admin','user'],
            password: bcrypt.hashSync('Z20Skk',10)
          }, {
            email: "mciobotaro1@wiley.com",
            fullName: "Maurise Ciobotaro",
            roles: ['user'],
            password: bcrypt.hashSync('45B4qaFxRxB2',10)
          }, {
            email: "zgooch2@jigsy.com",
            fullName: "Zonnya Gooch",
            roles: ['admin'],
            password: bcrypt.hashSync('xSGNqQghS',10)
          }, {
            email: "pstivey3@dedecms.com",
            fullName: "Perrine Stivey",
            roles: ['admin'],
            password: bcrypt.hashSync('RpZTNh1EhOYe',10)
          }, {
            email: "acasterou4@latimes.com",
            fullName: "Albertine Casterou",
            roles: ['admin'],
            password: bcrypt.hashSync('VuCoZA6',10)
          }, {
            email: "lgallone5@oakley.com",
            fullName: "Lew Gallone",
            roles: ['super-user'],
            password: bcrypt.hashSync('GeOsOXIUexg',10)
          }, {
            email: "tgotthard6@homestead.com",
            fullName: "Trescha Gotthard",
            roles: ['user'],
            password: bcrypt.hashSync('NUIYX1dbYw',10)
          }, {
            email: "dhaighton7@ibm.com",
            fullName: "Dael Haighton",
            roles: ['user'],
            password: bcrypt.hashSync('w4FjurvMr9r3',10)
          }, {
            email: "odrinkhall8@theglobeandmail.com",
            fullName: "Ode Drinkhall",
            roles: ['admin'],
            password: bcrypt.hashSync('uH2aV3Q3GuY',10)
          }, {
            email: "wducarne9@shutterfly.com",
            fullName: "Wait Ducarne",
            roles: ['super-user'],
            password: bcrypt.hashSync('e5mP5Ok',10)
          }, {
            email: "gjennricha@gmpg.org",
            fullName: "Ginni Jennrich",
            roles: ['super-user'],
            password: bcrypt.hashSync('YbfM0xmJE',10)
          }, {
            email: "kpowrieb@tumblr.com",
            fullName: "Kathe Powrie",
            roles: ['admin'],
            password: bcrypt.hashSync('Nd5o4in2YBP9',10)
          }, {
            email: "zkuhndelc@bravesites.com",
            fullName: "Zilvia Kuhndel",
            roles: ['user'],
            password: bcrypt.hashSync('phpLgJVu',10)
          }, {
            email: "pelvinsd@blogger.com",
            fullName: "Phylis Elvins",
            roles: ['user'],
            password: bcrypt.hashSync('8KrV2ke4If',10)
          }, {
            email: "gquarlese@pinterest.com",
            fullName: "Grange Quarles",
            roles: ['super-user'],
            password: bcrypt.hashSync('Kgwi3KlXibm',10)
          }, {
            email: "iprivostf@hp.com",
            fullName: "Ingmar Privost",
            roles: ['admin'],
            password: bcrypt.hashSync('EeEyoP',10)
          }, {
            email: "jmccurrieg@zdnet.com",
            fullName: "Julissa McCurrie",
            roles: ['user'],
            password: bcrypt.hashSync('cCcVnj3RvQT',10)
          }, {
            email: "ycaneyh@lulu.com",
            fullName: "Yasmin Caney",
            roles: ['super-user'],
            password: bcrypt.hashSync('wqNeAfDnfr',10)
          }, {
            email: "rrumsbyi@samsung.com",
            fullName: "Reggie Rumsby",
            roles: ['user'],
            password: bcrypt.hashSync('P9orAu',10)
          }, {
            email: "cranklinj@jiathis.com",
            fullName: "Cross Ranklin",
            roles: ['admin'],
            password: bcrypt.hashSync('a2tQ4QMCN',10)
          }, {
            email: "wlockittk@hatena.ne.jp",
            fullName: "Winifield Lockitt",
            roles: ['user'],
            password: bcrypt.hashSync('SVdw3xtFUAyy',10)
          }, {
            email: "cpickersaill@eventbrite.com",
            fullName: "Chrotoem Pickersail",
            roles: ['super-user'],
            password: bcrypt.hashSync('EV749Yj',10)
          }, {
            email: "mboshellm@go.com",
            fullName: "Melba Boshell",
            roles: ['user'],
            password: bcrypt.hashSync('dZ0CLWt6DiaD',10)
          }, {
            email: "cparison@wordpress.com",
            fullName: "Caroline Pariso",
            roles: ['user'],
            password: bcrypt.hashSync('SvjTa6LyXcv',10)
          }, {
            email: "rlinningo@addthis.com",
            fullName: "Ruthie Linning",
            roles: ['super-user'],
            password: bcrypt.hashSync('JMm1NVmK3',10)
          }, {
            email: "ldelacourtp@eepurl.com",
            fullName: "Link Delacourt",
            roles: ['admin'],
            password: bcrypt.hashSync('Siv1SL7',10)
          }, {
            email: "wsweetloveq@angelfire.com",
            fullName: "Winna Sweetlove",
            roles: ['user'],
            password: bcrypt.hashSync('8d0pAGSPIw',10)
          }, {
            email: "eforrestr@epa.gov",
            fullName: "Elmer Forrest",
            roles: ['user'],
            password: bcrypt.hashSync('xmls7f',10)
          }, {
            email: "gemmisons@sbwire.com",
            fullName: "Glennie Emmison",
            roles: ['super-user'],
            password: bcrypt.hashSync('vOyx1PL9Lx1',10)
          }, {
            email: "afablert@sitemeter.com",
            fullName: "Alastair Fabler",
            roles: ['admin'],
            password: bcrypt.hashSync('tlFrrSd6qOs2',10)
          }
    ],
